                ...
                <div className="flex items-center gap-4">
                    ...
                    <motion.button
                        ...
                        onClick={async () => {
                            ...
                            const childId = sessionStorage.getItem('activeChildId');
                            if (childId) {
                                await fetch(`/api/progress?child_id=${childId}`, { method: 'DELETE' });
                                window.location.reload();
                            }
                        }}
                        className="bg-white/90 backdrop-blur-xl rounded-2xl p-3 shadow-lg border border-white/50 flex items-center justify-center cursor-pointer hover:bg-red-50 text-slate-400 hover:text-red-500 transition-colors"
                        title="Reset Roadmap"
                    >
